...
using Zavrsni_rad.PageObjects;
using ShopQaHomePage = Zavrsni_rad.PageObjects.HomePage;
using ShopQaLoginPage = Zavrsni_rad.PageObjects.LoginPage;
using ShopQaCartPage = Zavrsni_rad.PageObjects.CartPage;
using ShopQaConfirmationPage = Zavrsni_rad.PageObjects.ConfirmationPage;
